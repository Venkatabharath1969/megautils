...
// Pre-generation combos — REVERTED to original 120 pages after Google August 2026
// Spam Update hit the site. The 900-page expansion likely triggered "scaled content"
// flags on a 1-month-old domain. Keep these conservative until domain authority builds.
const PERCENTAGES = [5, 10, 15, 20, 25, 30, 40, 50, 60, 75, 80, 90]
const BASES = [50, 100, 150, 200, 250, 300, 400, 500, 750, 1000]

// ---------------------------------------------------------------------------
// Static params (120 pages — conservative for spam recovery)
// ---------------------------------------------------------------------------
