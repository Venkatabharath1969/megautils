...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const tools = [
    ...
    'cagr-calculator', 'case-converter', 'chmod-calculator', 'citation-generator', 'code-to-image',
    ...
    'length-converter', 'line-number-adder', 'list-tools', 'loan-comparison-calculator', 'logo-maker',
    ...
    'weight-converter', 'whiteboard', 'word-counter', 'word-to-pdf', 'xml-escape', 'xml-formatter', 'xml-to-json',
