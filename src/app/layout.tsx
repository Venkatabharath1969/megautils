...
export const metadata: Metadata = {
  title: {
    default: 'UtilsNow - 230+ Free Online Tools for Developers & Everyone',
    template: '%s | UtilsNow',
  },
  ...
  openGraph: {
    title: 'UtilsNow - 230+ Free Online Tools',
    description: 'Free online developer tools, calculators, converters, and more. No login. No data stored.',
    url: 'https://utilsnow.com',
    siteName: 'UtilsNow',
    type: 'website',
    images: [{ url: '/opengraph-image.png', width: 1200, height: 630, alt: 'UtilsNow - 230+ Free Online Tools' }],
  },
  twitter: { card: 'summary_large_image', title: 'UtilsNow - 230+ Free Online Tools', description: 'Free online developer tools, calculators, converters, and more.', images: ['/opengraph-image.png'] },
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              name: 'UtilsNow',
              url: 'https://utilsnow.com',
              description: '230+ free browser-based utility tools for developers, designers, and everyone.',
              sameAs: [
