    ...
    <ToolPage title="Headline Analyzer" description="Analyze your headline for word count, power words, emotional impact, and SERP readiness." category="content" categoryLabel="Content Tools"
      helpContent={
        <>
          ...
          <p>Headline Analyzer is a free browser-based tool that lets you analyze headlines for emotional impact, power words, readability, and SEO effectiveness with a composite score. It processes everything locally in your browser using JavaScript, so your data never leaves your device. No sign-up, no installation, and no server uploads required — just open the tool and start using it immediately.</p>

          <h2>How to Use This Tool</h2>
          <ol>
            <li>Enter or paste the text or content you want to analyze or transform.</li>
          ...
          <p>This tool is particularly useful when crafting compelling blog titles, email subject lines, social media posts, or advertising copy that drives clicks. Since it runs entirely in your browser, it works offline after the page loads and keeps your data completely private. Whether you are a developer, designer, student, or professional, this content marketing tool saves time and eliminates the need for desktop software installation.</p>

          <h2>Tips and Best Practices</h2>
          <ul>
            <li>Analyze your content before publishing to optimize for engagement and readability.</li>
