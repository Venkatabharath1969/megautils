...
export default function TextToBinaryTool() {
  ...
  return (
    <ToolPage title="Text to Binary" description="Convert text to 8-bit binary representation and binary back to text." category="encoders" categoryLabel="Encoders & Decoders">
