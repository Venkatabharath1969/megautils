    ...
    <ToolPage
      ...
      helpContent={
        <>
          ...
          <p>CAGR Calculator is a free browser-based tool that lets you calculate Compound Annual Growth Rate to measure the mean annual growth rate of an investment over a specified period. It processes everything locally in your browser using JavaScript, so your data never leaves your device. No sign-up, no installation, and no server uploads required — just open the tool and start using it immediately.</p>
          ...
          <p>This tool is particularly useful when evaluating investment performance, comparing fund returns, or projecting business growth rates. Since it runs entirely in your browser, it works offline after the page loads and keeps your data completely private. Whether you are a developer, designer, student, or professional, this finance tool saves time and eliminates the need for desktop software installation.</p>
          ...
          <ul>
            ...
            <li>Bookmark this page for quick access whenever you need cagr calculation.</li>
          </ul>
        </>
      }
      faqs={[
