    ...
    <ToolPage
      ...
      helpContent={
        <>
          ...
          <p>IRR Calculator is a free browser-based tool that lets you calculate the Internal Rate of Return for a series of cash flows to evaluate investment profitability. It processes everything locally in your browser using JavaScript, so your data never leaves your device. No sign-up, no installation, and no server uploads required — just open the tool and start using it immediately.</p>
          ...
          <p>This tool is particularly useful when comparing investment opportunities, evaluating project returns, or performing capital budgeting analysis. Since it runs entirely in your browser, it works offline after the page loads and keeps your data completely private. Whether you are a developer, designer, student, or professional, this finance tool saves time and eliminates the need for desktop software installation.</p>
          ...
          <ul>
            ...
            <li>Bookmark this page for quick access whenever you need irr calculation.</li>
          </ul>
        </>
      }
      faqs={[
