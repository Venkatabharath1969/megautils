    ...
    <ToolPage
      ...
      helpContent={
        <>
          ...
          <p>HTTP Status Codes Reference is a free browser-based tool that lets you a comprehensive reference of all HTTP status codes (1xx-5xx) with descriptions, use cases, and troubleshooting tips. It processes everything locally in your browser using JavaScript, so your data never leaves your device. No sign-up, no installation, and no server uploads required — just open the tool and start using it immediately.</p>
          ...
          <p>This tool is particularly useful when debugging API responses, understanding server errors, or learning about HTTP protocol status codes. Since it runs entirely in your browser, it works offline after the page loads and keeps your data completely private. Whether you are a developer, designer, student, or professional, this web development tool saves time and eliminates the need for desktop software installation.</p>
          ...
          <ul>
            ...
            <li>Bookmark this page for quick access whenever you need http status reference.</li>
          </ul>
        </>
      }
      faqs={[
